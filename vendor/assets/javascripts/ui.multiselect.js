...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedActions = $('<div class="ui_multiselect_actions ui-widget-header ui-helper-clearfix"><span class="count">0 '+$.ui.multiselect.locale.itemsCount+'</span><a href="#" class="remove-all">'+$.ui.multiselect.locale.removeAll+'</a></div>').appendTo(this.selectedContainer);
		this.availableActions = $('<div class="ui_multiselect_actions ui-widget-header ui-helper-clearfix"><input type="text" class="search empty ui-widget-content ui-corner-all"/><a href="#" class="add-all">'+$.ui.multiselect.locale.addAll+'</a></div>').appendTo(this.availableContainer);
	...
	_getOptionNode: function(option) {
		option = $(option);
		var node = $('<li class="ui-state-default ui-element" title="'+option.text()+'"><span class="ui-icon"/>'+option.text()+'<a href="#" class="ui_multiselect_action"><span class="ui-corner-all ui-icon"/></a></li>').hide();
    ...
    if (selected) {
			...
			item.find('a.ui_multiselect_action span').addClass('ui-icon-minus').removeClass('ui-icon-plus');
			this._registerRemoveEvents(item.find('a.ui_multiselect_action'));
		} else {
			item.children('span').removeClass('ui-icon-arrowthick-2-n-s').addClass('ui-helper-hidden').removeClass('ui-icon');
			item.find('a.ui_multiselect_action span').addClass('ui-icon-plus').removeClass('ui-icon-minus');
			this._registerAddEvents(item.find('a.ui_multiselect_action'));
		}
	...
	_registerDoubleClickEvents: function(elements) {
		...
		elements.dblclick(function() {
			elements.find('a.ui_multiselect_action').click();
		});
	},
